...
final class DeveloperPreview {
    ...
    let previewHomeViewModel = HomeCryptoListViewModel(
        fetchCryptoPricesUseCase: PreviewFetchCryptoPricesUseCase()
    )

    let previewCoinDetailViewModel = CoinDetailViewModel(
        fetchCrypoDetailUseCase: PreviewFetchCrypoDetailUseCase(),
